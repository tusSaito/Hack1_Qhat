...
export function CharacterPortrait({
  ...
  return (
    ...
    >
      ...
      {/* brows */}
      <g transform="translate(0, -10)">{brows(thinking ? "confusion" : emotion)}</g>
      {/* eyes */}
      <g transform="translate(0, 5)">
        {eyeFor(thinking ? "confusion" : emotion, -22)}
        {eyeFor(thinking ? "confusion" : emotion, 22)}
      </g>
      {/* blush for joy */}
      ...
      {/* mouth */}
      <g transform="translate(0, 28)">{mouthFor(thinking ? "confusion" : emotion)}</g>
      {/* sweat for anxiety */}
